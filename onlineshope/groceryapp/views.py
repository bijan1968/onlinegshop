...
from .models import Carousel, Category, Product, UserProfile, User, Cart, Booking, ORDERSTATUS, Feedback
#from .models import *
...
def about(request):
    return render(request, 'gapp/about.html')

def main(request):
    data = Carousel.objects.all()
    dic = {'data': data}
    return render(request, 'gapp/index.html', dic)
...
def adminLogin(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            msg = "Invalid Credentials"
    dic = {'msg': msg}
    return render(request, 'gapp/admin_login.html', dic)

def adminHome(request):
    return render(request, 'gapp/admin_base.html')
...
def admin_dashboard(request):
    ...
    return render(request, 'gapp/admin_dashboard.html', locals())
...
def add_category(request):
    ...
    return render(request, 'gapp/add_category.html', locals())

def view_category(request):
    category = Category.objects.all()
    return render(request, 'gapp/view_category.html', locals())
...
def edit_category(request, pid):
    ...
    return render(request, 'gapp/edit_category.html', locals())
...
def add_product(request):
    ...
    return render(request, 'gapp/add_product.html', locals())

def view_product(request):
    product = Product.objects.all()
    return render(request, 'gapp/view_product.html', locals())
...
def edit_product(request, pid):
    ...
    if request.method == "POST":
        ...
        return redirect('view_product')
    return render(request, 'gapp/edit_product.html', locals())
...
def registration(request):
    ...
    return render(request, 'gapp/registration.html', locals())
...
def booking(request):
    ...
    if request.method == "POST":
        return redirect(
            '/payment/?total=' + str(total) + '&discounted=' + str(discounted) + '&deduction=' + str(deduction))
